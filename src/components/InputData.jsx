...
function addData(value, setLetters, setLettersNumbers, setNumbers, numbers, lettersNumbers, letters, setOpen) {
...
export default function InputData({
	...
	function handlerOnKeyPress(e) {
		if (e.key === 'Enter' && e.target.value !== '') {
			addData(e.target.value, setLetters, setLettersNumbers, setNumbers, numbers, lettersNumbers, letters, setOpen)
			setValue('')
		}
